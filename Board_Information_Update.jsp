            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">보고서 수정</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">MAIN</a></li>
                            <li class="breadcrumb-item active">보고서 수정</li>
                        </ol>
                    </div>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form action="Board_Information_Update_Query.jsp" method="get">
                            <%
                            ...
                            try{
								...
								ResultSet rs = stmt.executeQuery("select * from board where bno="+bno+"");
								...
								while(rs.next()){
									...
									out.println("<div class='form-group'><label class='col-md-12'>보고서 제목</label><div class='col-md-12'><input type='text' placeholder='' class='form-control form-control-line' name='_btitle' value='"+rs.getString("btitle")+"' ></div></div>");
									out.println("<div class='form-group'><label class='col-md-12'>담당경찰</label><div class='col-md-12'><input type='text' placeholder='' class='form-control form-control-line' name='_cp' value="+rs.getString("cp")+" ></div></div>");
									out.println("<div class='form-group'><label class='col-md-12'>보고서 내용</label><div class='col-md-12'><textarea class='form-control form-control-line' name='_bcontent'  placeholder='' cols=30 rows=20  >"+rs.getString("bcontent")+"</textarea></div></div>");
