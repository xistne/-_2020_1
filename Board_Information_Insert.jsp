                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form class="form-horizontal form-material" action="Board_Information_Insert_Query.jsp" method="post">
                            ...
                            %>
                                        ...
                                        <label class="col-md-12">보고서 제목</label>
                                        <div class="col-md-12">
                                        <!--  보고서 제목 띄어쓰기 하면 잘림 -->
                                            <input type="text" placeholder="" class="form-control form-control-line" name="_btitle" >
                                        </div>
                                    	</div>
                                    	<div class="form-group">
                                        <label class="col-md-12">작성자</label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="" class="form-control form-control-line" value=<%=s_name %> disabled />
                                        </div>
                                    	</div>
                                    	<div class="form-group">
                                        <label class="col-md-12">담당경찰</label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="" class="form-control form-control-line" name="_cp" >
                                        </div>
                                    	</div>
                                    	<div class="form-group">
                                        <label class="col-md-12">보고서 내용</label>
                                        <div class="col-md-12">               
                                            <textarea class="form-control form-control-line" name="_bcontent"  placeholder="" cols=30 rows=20></textarea>
                                        </div>
                                    	</div>
