                ...
                <!-- ============================================================== -->
                 <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">신고 내역 관리</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">MAIN</a></li>
                            <li class="breadcrumb-item active">신고 내역 관리</li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card card-body mailbox">
                            ...
                            try{
                                ...
                                Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/testdb_C?useUnicode=true&characterEncoding=utf8","root","1234");
                                Statement stmt = conn.createStatement();
                                Statement stmt1 = conn.createStatement();
                                ResultSet rs = stmt.executeQuery("select * from report order by rdate asc");
								

                                while(rs.next()){
                                	
                                	ResultSet rs1 = stmt1.executeQuery("select * from board where rno="+rs.getString("rno"));
                                	if(rs1.next()){
                                		out.println("<a href='Report_Management_Detail.jsp?_rno="+rs.getString("rno")+"'>");
                                        out.println("<div class='btn bg-light-danger btn-circle'><i class='fa fa-flag'></i></div>");
                                        out.println("<div class='mail-contnet'>");
                                        out.println("<h5>"+ rs.getString("rno") +"</h5> <span class='mail-desc'>"+ rs.getString("raddr") +"</span> <span class='time'>"+ rs.getString("rdate") +"</span> </div>");
                                        out.println("</a>");
                                		
                                	}else{
                                		out.println("<a href='Report_Management_Detail.jsp?_rno="+rs.getString("rno")+"'>");
                                        out.println("<div class='btn btn-danger btn-circle'><i class='fa fa-flag'></i></div>");
                                        out.println("<div class='mail-contnet'>");
                                        out.println("<h5>"+ rs.getString("rno") +"</h5> <span class='mail-desc'>"+ rs.getString("raddr") +"</span> <span class='time'>"+ rs.getString("rdate") +"</span> </div>");
                                        out.println("</a>");
                                	}
