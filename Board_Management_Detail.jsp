            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">보고서 작성</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">MAIN</a></li>
                            <li class="breadcrumb-item active">보고서 작성</li>
                        </ol>
                    </div>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form class="form-horizontal form-material" action="Board_Information_Update.jsp" method="get">
                            <div style="padding:10px;"> </div>
                            
                            <%
                            
                            String bno = request.getParameter("_bno");
                            
                            try{
								Class.forName("com.mysql.jdbc.Driver");
								Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/testdb_C","root","1234");
								Statement stmt = conn.createStatement();
								ResultSet rs = stmt.executeQuery("select * from board, report, android where bno="+bno+" and board.rno = report.rno and report.a_uid = android.a_uid");
								
								
								while(rs.next()){
									
									out.println("<div class='table-responsive'><table class='table'><tbody><tr><td>"+rs.getString("bno")+"</td>");
									out.println("<td> ["+rs.getString("btitle")+"]</td>");
									out.println("<td> 작성자:"+s_name +"</td>");
									out.println("<td> 작성 날짜 : "+(rs.getString("bdate")).substring(0,10)+"&emsp;"+"</td></tr></tbody></table></div><hr><br>");
									...
									//out.println("<div class='form-group'><label class='col-md-12'>보고서 제목</label><div class='col-md-12'><input type='text' placeholder='' class='form-control form-control-line' value='"+rs.getString("btitle")+"' disabled/></div></div>");
									out.println("<div class='form-group'><label class='col-md-12'>담당경찰</label><div class='col-md-12'><input type='text' placeholder='' class='form-control form-control-line' value="+rs.getString("cp")+" disabled/></div></div>");
									out.println("<div class='form-group'><label class='col-md-12'>보고서 내용</label><div class='col-md-12'><textarea class='form-control form-control-line' name='_bcontent'  placeholder='Enter your message' cols=30 rows=20  disabled/>"+rs.getString("bcontent")+"</textarea></div></div>");
                            ...
                            %>     
								    ...
								    <input type="hidden" name="_bno" value=<%=bno %>  />
									 <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success">보고서 수정</button>
                                        </div>
                                    </div>
								</form>
							</div>
